...
#ifndef AWESOME_LOGGER_SWIFT_H
#define AWESOME_LOGGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="awesome_logger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14awesome_logger11AppDelegate")
...
SWIFT_CLASS("_TtC14awesome_logger17MainFlutterWindow")
